...
package br.com.rsousa.vendas.online;
...
import br.com.rsousa.vendas.online.resources.ClienteResource;
import br.com.rsousa.vendas.online.usecase.BuscaCliente;
import br.com.rsousa.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("Renan 1").build();
